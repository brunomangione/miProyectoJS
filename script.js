// PROYECTO JS CODERHOUSE - CONVERSOR DE MONEDAS
// ALUMNO BRUNO MANGIONE
...
function calculate() {
    ...
    fetch(`https://api.exchangerate-api.com/v4/latest/${moneda_one}`) //Se elije v4 porque no pide una API KEY
        .then(res => res.json())
        .then(data => {
